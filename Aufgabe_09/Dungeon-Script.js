...
let monsterModifers = ["Giftig", "Feuerfest", "Giftresistend", "Aufgebracht", "Wachsam", "Schnell", "Wasserscheu", "Glühend"]; // Eine Reihe von zufälligen Verstärkern/Zusätzen für das Monster. length = 8, da 8 Einträge. Von 0-7.
...
function generateMonster() {
    ...
    for (let i = 0; i < RandomMonster; i++) //for-Schleife führt den Code so oft aus wie die Zahl groß ist
     {
...
function getMonsterCount() {
    let monsterCnt = monsterArray.length;
